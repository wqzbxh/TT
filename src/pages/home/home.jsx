  ...
  render() {
    ...
    return (
      <div className="overflow-y-auto  md:mx-auto">
          ...
          <table className="text-center  table-auto min-w-full divide-y divide-gray-200">
            <thead>
              <tr className=" text-xs">
                ...
                <th
                  scope="col"
                  className="px-6 py-3 font-semibold text-center text-gray-500 uppercase tracking-wider bg-blue-50"
                >
                  Total Time
                </th>
                <th
                  scope="col"
                  className="px-6 py-3 font-semibold text-center text-gray-500 uppercase tracking-wider"
                >
                  Mo
                </th>
                <th
                    ...
                    item.detaile.length > 0
                      ? item.detaile.map((detaileItem, detaileIndex) => {
                          return (
                            <tr
                              key={detaileItem.id}
                              className="text-center italic md:not-italic text-xs bg-gray-200"
                            >
                              ...
                              <td className="px-6 py-4 whitespace-wrap ">
                                {detaileItem.time.di == "00:00"
                                  ? ""
                                  : detaileItem.time.di}  &nbsp; &nbsp;<span   onClick={() => this.handleEditSheet(detaileItem.id,'di')}  className="iconfont text-xs icon-bianji3"></span>
                              </td>
                              <td className="px-6 py-4 whitespace-wrap">
                                {detaileItem.time.mi == "00:00"
                                  ? ""
                                  : detaileItem.time.mi}  &nbsp; &nbsp;<span   onClick={() => this.handleEditSheet(detaileItem.id,'mi')}  className="iconfont text-xs icon-bianji3"></span>
                              </td>
                              <td className="px-6 py-4 whitespace-wrap ">
                                {" "}
                                {detaileItem.time.do == "00:00"
                                  ? ""
                                  : detaileItem.time.do}  &nbsp; &nbsp;<span   onClick={() => this.handleEditSheet(detaileItem.id,'do')}  className="iconfont text-xs icon-bianji3"></span>
                              </td>
                              <td className="px-6 py-4 whitespace-wrap">
                                {" "}
                                {detaileItem.time.fr == "00:00"
                                  ? ""
                                  : detaileItem.time.fr }  &nbsp; &nbsp;<span   onClick={() => this.handleEditSheet(detaileItem.id,'fr')}  className="iconfont text-xs icon-bianji3"></span> 
                              ...
                              <td className="px-6 py-4 whitespace-wrap ">
                                ...
                                {detaileItem.time.sa == "00:00"
                                  ? ""
                                  : detaileItem.time.sa}  &nbsp; &nbsp;  <span    onClick={() => this.handleEditSheet(detaileItem.id,'sa')} className="iconfont text-xs icon-bianji3"></span>
                              </td>
                              <td className="px-6 py-4 whitespace-wrap ">
                                {detaileItem.time.so == "00:00"
                                  ? ""
                                  : detaileItem.time.so}  &nbsp; &nbsp;<span    onClick={() => this.handleEditSheet(detaileItem.id,'so')}  className="iconfont text-xs icon-bianji3"></span>
                              </td>
                              <td className="px-6 py-4 whitespace-wrap">
            ...
            <thead>
              <tr className="bg-blue-50">
                ...
                <th
                  ...
                  className="px-6 py-3 font-semibold text-center text-gray-600 uppercase tracking-wider"
                >
                  <div className=" h-2 mt-2 text-xs">90 % </div>&nbsp;&nbsp;
                  <div className="relative h-2 bg-gray-200">
                    <div
        ...
        <Quill isVisible={this.state.isModalOpen} id={this.state.sheetid} week_day={this.state.week_day}  closeSheet={this.closeMadalSheet}/>
      </div>
    );
  }
}
