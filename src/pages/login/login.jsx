        ...
        return (
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <h2 className="mt-10 text-center text-2xl font-bold leading-9  tracking-tight text-customize-primary-2">Sign in to your  account</h2>
                </div>
                    ...
                    <form className="max-w-md mx-auto">
                        ...
                        <div className="mb-6">
                            <div className="flex items-center mb-6">
                                ...
                                <label htmlFor="is_remember" className="ml-2 text-customize-primary-2 font-medium underline">Remember Me</label>
                            </div>
